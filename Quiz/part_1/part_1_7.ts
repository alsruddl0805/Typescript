// Part 1 _ 7 : 타입도 변수에 담아쓰세요 type 키워드 써서 & readonly

// Q1. object 타입을 정의한 type alias 두개를 & 기호로 합칠 때 중복된 속성이 있으면 어떻게 될까요?
// type x = {name : string};
// type y = {name : number};
// type XandY = x & y;
// let name3:XandY = {name : '테스트'};
...
type resObject = object2 & isAdult;

let checkObjeect2_2 :resObject = {
    name: 'kim',
    phone: 1012341234,
    email: 'test@com',
    isAdult: true,
